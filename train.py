...
if __name__ == '__main__':
    ...
    create_deploy_class('/data/model_cache/deploy_class.prototxt', str(len(os.walk(data_path).next()[1])))
    os.chdir("/data/model_cache/")
    subprocess.call('cp /tmp/train.txt /data/model_cache/train.txt', shell=True)
    subprocess.call('cp /tmp/caffe/images/train_lmdb/train.binaryproto /data/model_cache/train.binaryproto', shell=True)
