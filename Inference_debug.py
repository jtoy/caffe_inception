''' Given a model and an input image, this script will go through each layer
of the model and generate and output image for it.

usage: python inference_debug.py --base-model $CAFFE_ROOT/models/bvlc_googlenet \
